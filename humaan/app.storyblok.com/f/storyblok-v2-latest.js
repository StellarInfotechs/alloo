! function(e) {
    ...
    const e = e => document.querySelector(`[data-blok-uid="${e}"]`),
        ...
        s = e => {
            ...
            return o.setAttribute("d", e.path), o.setAttribute("fill", e.pathFill), o.setAttribute("transform", e.pathTransform ? e.pathTransform : "translate(0 0)"), t.appendChild(o), t
        };
    ...
    class m {
        constructor(e) {
            this.appVersion = "v1", this.inEditor = !0, this.initialized = !1, this.currentUid = null, this.storyId = "", this.componentNames = {}, this.outlineOnMoveInterval = null, this.calcInterval = null, this.canAddBlocks = !1, this.canMoveForward = !1, this.navigationBreadcrumbs = [], this.focusState = !1, this.actionsEnabled = !1, this.hinter = null, this.highlighter = null, this.overlay = null, this.componentBase = null, this.componentLabel = null, this.breadcrumbsButtonMenu = null, this.breadcrumbsMenu = null, this.actionsMenu = null, this.actionsMenuButton = null, this.actionsMenuItems = null, this.events = {
                input: [],
                change: [],
                published: [],
                unpublished: [],
        ...
        init() {
            null !== document.body ? this.config.initOnlyOnce && document.querySelectorAll(".storyblok__hint").length > 0 || this.isInIframe && (this.resetAllEvents(), this.addMessageListener(), this.outlineOnMove(), this.buildBridgeStyles(), this.on("enterEditmode", this.enterEditmode), this.isInIframe && this.sendDataToEditor({
                action: "initialized",
                config: this.config
            }), this.initialized = !0) : console.error("Body tag not found. Please install the Storyblok bridge script inside the body tag")
        }
        keyPress(e, t) {
            ("z" === t.key && t.metaKey || "z" === t.key && t.ctrlKey) && (t.preventDefault(), t.stopImmediatePropagation(), e.sendDataToEditor({
                action: "undo"
            })), ("y" === t.key && t.metaKey || "y" === t.key && t.ctrlKey) && (t.preventDefault(), t.stopImmediatePropagation(), e.sendDataToEditor({
                action: "redo"
            }))
        }
        sendDataToEditor(e) {
        ...
        createOverlay() {
            this.overlay = document.createElement("div"), this.overlay.setAttribute("class", c), this.overlay.setAttribute("id", c), this.hideElement(this.overlay), document.body.appendChild(this.overlay)
        }
        calculateElementPosition(t, o) {
            ...
            if (n) {
                const {
                    left: e,
                    top: o
                } = this.getElementOffset(n);
                o <= 30 ? this.overlay.classList.add("storyblok__overlay--bottom") : this.overlay.classList.remove("storyblok__overlay--bottom"), t.style.top = `${o}px`, t.style.left = `${e}px`, t.style.width = `${n.offsetWidth}px`, t.style.height = `${n.offsetHeight}px`, t.style.minHeight = "5px"
        ...
        emit(e) {
            ...
            if (e && t && t.length)
                for (let e = 0; e < t.length; e++) t[e].apply(this, [].slice.call(arguments, 1))
        }
        outlineOnMoveHandler() {
            document.body.classList.add(l), this.outlineOnMoveInterval && clearTimeout(this.outlineOnMoveInterval), this.outlineOnMoveInterval = setTimeout(() => {
                document.body.classList.remove(l), this.hinter && (this.hinter.style.opacity = 0)
            }, 800)
        }
        outlineOnMove() {
        ...
        subscribeEvent(e, t) {
            "input" === e && (this.actionsEnabled = !0), -1 === this.events[e].indexOf(t) && this.events[e].push(t)
        }
        pingEditor(e) {
            this.isInIframe ? this.sendDataToEditor({
                action: "ping"
            }) : (this.inEditor = !1, e(this)), this.on("pingBack", this.handlePingBack(e))
        }
        handlePingBack(e) {
            return () => {
        ...
        handleEditedBlok(e) {
            this.navigationBreadcrumbs = e.breadcrumbs, this.canAddBlocks = e.canAddBlocks || !1, this.canMoveForward = e.canMoveForward || !1, this.updateComponentBase(e.blok)
        }
        handleAddMoveBlok(t) {
        ...
        handleOpenBlok(e, t) {
            ...
            if (o) {
                ...
                return (t && o.uid !== this.currentUid || t && e) && (t.preventDefault(), t.stopPropagation()), this.currentUid = o.uid, this.storyId = o.id, void this.openBlok(o)
            }
        ...
        enterEditmode(t) {
            ...
            for (let e = 0; e < n.length; e++) {
                const t = n[e].el,
                    o = n[e].options;
                t && (o.name = this.componentNames[o.name] || o.name, t.setAttribute("data-blok-c", JSON.stringify(o)), t.setAttribute("data-blok-uid", `${o.id}-${o.uid}`), t.offsetHeight < 5 && (t.style["min-height"] = "5px"), t.classList.add("storyblok__outline"))
            }
            ...
            window.addEventListener("click", this.handleWindowClick.bind(this)), null !== this.calcInterval && window.clearInterval(this.calcInterval), this.calcInterval = window.setInterval(() => {
                this.calculateElementPosition(this.overlay, `${this.storyId}-${this.currentUid}`)
            }, 300)
        }
        highlightComponent(o) {
            this.highlighter.innerHTML = "", o.componentIds.length > 0 ? (this.highlighter.style.display = "block", this.highlighter.style.opacity = 1) : (this.highlighter.style.display = "none", this.highlighter.style.opacity = 0);
            for (let n = 0; n < o.componentIds.length; n++) {
                const i = `${o.storyId}-${o.componentIds[n]}`,
                    s = e(i);
                if (s) {
                    const e = document.createElement("div");
                    e.setAttribute("class", "storyblok__highlight"), this.highlighter.appendChild(e), this.calculateElementPosition(e, i), o.componentId !== o.componentIds[n] || t(s) || void 0 === s.scrollIntoView || s.scrollIntoView()
                }
            }
        }
        hoverComponent(e) {
        ...
        toggleFocusElement(e, t = !1) {
            if (!this.overlay.contains(e)) {
                if (this.handleDeselectBlock(), !t && this.storyId === n("_storyblok")) return e.setAttribute("data-blok-focused", !0), this.showFocusedElement(this.overlay), void(this.focusState = !1);
        ...
        showFocusedElement(e) {
            this.currentUid ? (this.showElement(e), this.calculateElementPosition(e, `${this.storyId}-${this.currentUid}`)) : this.hideElement(e)
        }
        handleBlokActions(e) {
            this.sendDataToEditor({
                action: e,
                blok: this.lastBreadcrumbItem
            }), this.hideElement("addBlockBefore" === e || "addBlockAfter" === e || "copy" === e ? this.actionsMenu : this.overlay), "moveForward" !== e && "moveBackward" !== e || (this.focusState = !0)
        }
        hideElement(e) {
        ...
        enterComponent(t) {
            ...
            this.hinter.style.opacity = 0, this.hinter.style.display = "none", this.scrollIntoView(o), this.handleOpenBlok(o)
        }
        scrollIntoView(e) {
        ...
        createComponentBase() {
            this.componentBase = document.createElement("div"), this.componentBase.setAttribute("class", d), this.componentBase.setAttribute("id", d), this.overlay.append(this.componentBase)
        }
        createComponentLabel() {
            this.componentLabel = document.createElement("span"), this.componentLabel.setAttribute("class", "storyblok__overlay-menu-label"), this.componentBase.prepend(this.componentLabel)
        }
        createComponentButtonLabel() {
            const e = document.createElement("span");
            e.setAttribute("class", "storyblok__overlay-menu-label"), this.breadcrumbsButtonMenu.appendChild(e)
        }
        ...
        updateComponentBase(t) {
            this.hideElement(this.actionsMenu), this.hideElement(this.breadcrumbsMenu), this.overlay.classList.add("storyblok__overlay--clicked"), setTimeout(() => {
                this.overlay.classList.remove("storyblok__overlay--clicked")
            }, 400), this.navigationBreadcrumbs.length > 1 ? (this.updateBreadcrumbsMenu(this.navigationBreadcrumbs), this.actionsEnabled ? this.updateActionsMenu() : (this.componentBase.setAttribute("class", "storyblok__overlay-menu storyblok__overlay-menu--simple"), this.hideElement(this.actionsMenuButton)), this.hideElement(this.componentLabel)) : (this.hideElement(this.breadcrumbsButtonMenu), this.hideElement(this.actionsMenuButton), this.showElement(this.componentLabel)), this.updateComponentLabel(t);
            const o = e(`${this.storyId}-${t.uid}`);
            o && this.toggleFocusElement(o)
        }
        createBreadcrumbsMenuButton() {
            this.breadcrumbsButtonMenu = document.createElement("button"), this.breadcrumbsButtonMenu.setAttribute("class", "storyblok__overlay-menu-btn storyblok__overlay-menu-btn-parent"), this.breadcrumbsButtonMenu.prepend(s({
                viewBox: "0 0 24 24",
        ...
        createBreadcrumbsMenu() {
            this.breadcrumbsMenu = document.createElement("div"), this.breadcrumbsMenu.setAttribute("class", u), this.breadcrumbsMenu.setAttribute("id", u), this.componentBase.append(this.breadcrumbsMenu)
        }
        updateBreadcrumbsMenu(e) {
            this.breadcrumbsMenu.innerHTML = "";
            const t = [];
            for (let o = 0; o < e.length; o++) {
                t[o] = document.createElement("button"), t[o].innerHTML = i({
                    name: e[o].component
                });
                const n = e[o];
                t[o].addEventListener("click", e => {
                    e.stopPropagation(), this.currentUid = n._uid, this.openBlok({
                        id: this.storyId,
                        uid: n._uid,
                        name: n.component
                    })
                }), t[o].classList.add("storyblok__breadcrumbs-menu__menu-item"), e[o]._uid === this.currentUid && (t[o].classList.add("storyblok__breadcrumbs-menu__menu-item--selected"), t[o].setAttribute("disabled", !0)), this.breadcrumbsMenu.appendChild(t[o]), this.breadcrumbsButtonMenu.style.display = "flex"
            }
        }
        createActionsMenuButton() {
            this.actionsMenuButton = document.createElement("button"), this.actionsMenuButton.setAttribute("class", "storyblok__overlay-menu-btn storyblok__overlay-menu-btn-action"), this.actionsMenuButton.prepend(s({
                viewBox: "0 0 24 24",
                svgClass: "storyblok__overlay-menu-svg",
        ...
        createActionsMenu() {
            this.actionsMenu = document.createElement("div"), this.actionsMenu.setAttribute("class", h), this.actionsMenu.setAttribute("id", h), this.componentBase.append(this.actionsMenu)
        }
        updateActionsMenu() {
            this.actionsMenu.innerHTML = "", this.actionsMenuItems.sort((e, t) => e.order > t.order ? 1 : t.order > e.order ? -1 : 0).forEach(e => {
                if (e.separator && e.show()) return void this.actionsMenu.appendChild(document.createElement("hr"));
                const t = document.createElement(e.element ? e.element : "button");
                t.classList.add("storyblok__actions-menu__menu-item"), e.className && t.classList.add(e.className), t.innerHTML = e.innerHTML, e.eventFunction && t.addEventListener(e.event ? e.event : "click", e.eventFunction()), e.show() && this.actionsMenu.appendChild(t)
    ...
    void 0 !== window && (window.StoryblokBridge = class {
        constructor(e) {
            ...
            this.enterEditmode = e => {
                t.enterEditmode(e)
            }, this.isInEditor = () => t.isInEditor(), this.on = (e, o) => {
                t.on(e, o)
            }, this.pingEditor = e => {
                t.pingEditor(e)
            }
